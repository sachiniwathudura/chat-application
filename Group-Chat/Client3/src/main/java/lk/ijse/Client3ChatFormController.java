...
public class Client3ChatFormController implements Initializable {
    @FXML
    private javafx.scene.control.Button btnSendClient;

    @FXML
    private javafx.scene.image.ImageView emoIcon;
    ...
    @FXML
    private javafx.scene.image.ImageView icnCamera;
    ...
    @FXML
    private javafx.scene.control.TextField sendTxtAreaClient;

    @FXML
    private javafx.scene.control.ScrollPane spaneForFlowPane;
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        try {
            ...
            emojiContainer.setPadding(new javafx.geometry.Insets(10));
            emojiContainer.setHgap(20);
            emojiContainer.setVgap(20);
            emojiCategoryPane.setPadding(new javafx.geometry.Insets(0,10,0,10));
                ...
                try {
                    while (true){
                        ...
                        if (massage.startsWith("image")){
                            ...
                            javafx.scene.control.Label senderLabel = new javafx.scene.control.Label(sender+ ": ");
                            String path = din.readUTF();

                            javafx.scene.image.ImageView imageView = new javafx.scene.image.ImageView(new javafx.scene.image.Image("file:" + path));
                            ...
                            if (massage.startsWith("System")){
                                javafx.scene.control.Label label = new javafx.scene.control.Label(massage);
                                Platform.runLater(()->{
                                ...
                                Platform.runLater(()->{
                                    HBox hBox = new HBox();
                                    hBox.setPadding(new javafx.geometry.Insets(5,15,5,15));
...
//
        ...
        if (!massage.isEmpty()){
            try {
                Platform.runLater(()->{
                    ...
                    javafx.scene.control.Label label = new Label(massage+"\n");
                    label.setMaxWidth(300);
                    label.setWrapText(true);
                    hbox.getChildren().add(label);
                    hbox.setMaxWidth(Region.USE_PREF_SIZE);
    ...
    void icnCameraOnMouseClicked(MouseEvent mouseEvent) throws IOException {
        ...
        if (selectedFile != null) {
            ...
            javafx.scene.image.ImageView imageView = new ImageView(new Image("file:" + imagePath));
            imageView.setFitWidth(192);
            imageView.setPreserveRatio(true);
